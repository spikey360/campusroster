...
//first delete the original/s
$query="UPDATE entity SET delStatus = '1' WHERE eid =$deid";
$res=mysql_query($query);
if($res){
//well done, we continue adding new entry
}else{
echo "ER0";
echo "$query";
exit();
...
//academics
$query="INSERT INTO `academ`(`eid`, `backCurr`, `backPrev`, `sgpa1`, `sgpa2`, `sgpa3`, `sgpa4`, `sgpa5`, `sgpa6`, `sgpa7`, `sgpa8`, `cgpa`, `avg`) VALUES ('$eid','$cb','$pb','$p1','$p2','$p3','$p4','$p5','$p6','$p7','$p8','$cgpa','$avg')";
$res=mysql_query($query);
if($res){
